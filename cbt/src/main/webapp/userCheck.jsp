...
<head>
  <!--          meta 선언          -->
    ...
    <link rel="stylesheet" href="css/userCheck.css?v=1">
...
<div class = "middle">
    ...
    <h2 class="logo">내정보 확인</h2>
    <div class = "check_container">
		<label for="id">아이디 : ${loginUser.id }</label>
		<label for="pwd">비밀번호 : ${loginUser.pwd }</label>
		<label for="name">이름 : ${loginUser.username }</label>
		<input type = "submit" class = "check" value = "확인" onclick="location.href = 'mypage.jsp'">
