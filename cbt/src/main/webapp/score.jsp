...
<head>
 <!--          meta 선언          -->
    ...
    <link rel="stylesheet" href="css/score.css?v=1">
            ...
            <div class="inner">
                    ...
                    <div class="box">
                        ...
                        <div class="info">
                            ...
                            <li><a href="score.jsp">점수 확인</a></li>
                        </div>
                    </div>
                </div>
		...
		<script type="text/javascript">
            ...
            var myChart = new Chart(context, {
                ...
                data: { // 차트에 들어갈 데이터
                    labels: [
                        //x 축
                        '2023.08.24','2023.09.01','2023.09.24','2023.09.25', '2023.09.27'
                    ],
                    datasets: [
                        { //데이터
                            label: '시험점수', //차트 제목
                            ...
                            data: [
                                75, 55, 80, 60, 25 //x축 label에 대응되는 데이터 값
                            ],
                            backgroundColor: [
                                //색상
                                'rgba(255, 99, 132, 0.2)',
