...
<head>
  <!--          meta 선언          -->
    ...
    <link rel="stylesheet" href="css/userOut.css">
...
<%
	try{
		String result = (String)request.getAttribute("outCheck");
		...
		{
		%>
		<script>alert("회원정보가 일치하지 않습니다.")</script>
		<%
		}
		}catch(Exception e){
			System.out.println();
...
<div class = "middle">
    ...
    <h2 class="logo">회원 탈퇴</h2>
    <div class = "out_container">
	<form action ="userOut.do" method='post' name ='frm'>
		<label for="id">아이디 : </label>
		<input type = "text" name = "id" class = "input">
		<label for="pwd">비밀번호 : </label>
		<input type="password" name="pwd" class = "input">
		<input type = "submit" class = "out" value = "회원탈퇴" onclick="return outCheck()">
	</form>
	</div>
