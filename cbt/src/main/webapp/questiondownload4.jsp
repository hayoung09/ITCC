...
<body>
   ...
   <div class="board_wrap">
        <div class="board_title">
            ...
            <p>정보처리기사 필기 기출문제 2021년 03월 07일</p>

        </div>
        <div class="board_view_wrap">
            <div class="board_view">
                <div class="title">
                    정보처리기사 필기 기출문제 2021년 03월 07일
                </div>
                <div class="info">
                    <dl>
                        <dt>번호</dt>
                ...
                <div class="cont">
                    ...
                    <br>
                    정보처리기사 필기 기출문제 2021년 03월 07일(교사용)<br>
                    <a href="./file/정보처리기사20210307(교사용).hwp"download>정보처리기사20210307(교사용).hwp</a><br>
                    <a href="./file/정보처리기사20210307(교사용).pdf"download>정보처리기사20210307(교사용).pdf</a><br>
                    <br>
                    정보처리기사 필기 기출문제 2021년 03월 07일(학생용)<br>
                    <a href="./file/정보처리기사20210307(학생용).hwp"download>정보처리기사20210307(학생용).hwp</a><br>
                    <a href="./file/정보처리기사20210307(학생용).pdf"download>정보처리기사20210307(학생용).pdf</a><br>
                    <br>
                    정보처리기사 필기 기출문제 2021년 03월 07일(해설집)<br>
                    <a href="./file/정보처리기사20210307(해설집).hwp"download>정보처리기사20210307(해설집).hwp</a><br>
                    <a href="./file/정보처리기사20210307(해설집).pdf"download>정보처리기사20210307(해설집).pdf</a><br>
                </div>
                <div class="download">
                    <dl>
                        <dt>첨부</dt>
                    ...
                    <dl>
                        <dt><a href="./file/정보처리기사20210307(교사용).hwp"download>정보처리기사20210307(교사용).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20210307(교사용).pdf"download>정보처리기사20210307(교사용).pdf</a></dd>
                    </dl>
                    <dl>
                        <dt><a href="./file/정보처리기사20210307(학생용).hwp"download>정보처리기사20210307(학생용).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20210307(학생용).pdf"download>정보처리기사20210307(학생용).pdf</a></dd>
                    </dl>
                    <dl>
                        <dt><a href="./file/정보처리기사20210307(해설집).hwp"download>정보처리기사20210307(해설집).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20210307(해설집).pdf"download>정보처리기사20210307(해설집).pdf</a></dd>
                    </dl>
                </div>
