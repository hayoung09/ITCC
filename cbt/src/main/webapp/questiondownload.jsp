...
<div class="board_wrap">
        <div class="board_title">
            ...
            <p>정보처리기사 필기 기출문제 2022년 04월 24일</p>

        </div>
        <div class="board_view_wrap">
            <div class="board_view">
                <div class="title">
                    정보처리기사 필기 기출문제 2022년 04월 24일
                </div>
                <div class="info">
                    <dl>
                        <dt>번호</dt>
                ...
                <div class="cont">
                    ...
                    <br>
                    정보처리기사 필기 기출문제 2022년 04월 24일(2회)(교사용)<br>
                    <a href="./file/정보처리기사20220424(교사용).hwp"download>정보처리기사20220424(교사용).hwp</a><br>
                    <a href="./file/정보처리기사20220424(교사용).pdf"download>정보처리기사20220424(교사용).pdf</a><br>
                    <br>
                    정보처리기사 필기 기출문제 2022년 04월 24일(2회)(학생용)<br>
                    <a href="./file/정보처리기사20220424(학생용).hwp"download>정보처리기사20220424(학생용).hwp</a><br>
                    <a href="./file/정보처리기사20220424(학생용).pdf"download>정보처리기사20220424(학생용).pdf</a><br>
                    <br>
                    정보처리기사 필기 기출문제 2022년 04월 24일(2회)(해설집)<br>
                    <a href="./file/정보처리기사20220424(해설집).hwp"download>정보처리기사20220424(해설집).hwp</a><br>
                    <a href="./file/정보처리기사20220424(해설집).pdf"download>정보처리기사20220424(해설집).pdf</a><br>
                </div>
                <div class="download">
                    <dl>
                        <dt>첨부</dt>
                    ...
                    <dl>
                        <dt><a href="./file/정보처리기사20220424(교사용).hwp"download>정보처리기사20220424(교사용).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20220424(교사용).pdf"download>정보처리기사20220424(교사용).pdf</a></dd>
                    </dl>
                    <dl>
                        <dt><a href="./file/정보처리기사20220424(학생용).hwp"download>정보처리기사20220424(학생용).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20220424(학생용).pdf"download>정보처리기사20220424(학생용).pdf</a></dd>
                    </dl>
                    <dl>
                        <dt><a href="./file/정보처리기사20220424(해설집).hwp"download>정보처리기사20220424(해설집).hwp</a></dt>
                        <dd><a href="./file/정보처리기사20220424(해설집).pdf"download>정보처리기사20220424(해설집).pdf</a></dd>
                    </dl>
                </div>
